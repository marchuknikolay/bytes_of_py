...
Your team uses Sphinx and wants you to comply with its standards for docstrings. As per the Sphinx-RTD-Tutorial a
typical Sphinx docstring has the following format:
...
Note:We will be adding annotations to this function in the next Bite so you will need to complete this Bite to unlock
the next.
"""
